...
const Errors = require("../api/errors/bcaa21sft04-main-error.js");
...
const logger = LoggerFactory.get("Bcaa21sft04MainAbl");

class Bcaa21sft04MainAbl {
  constructor() {
  ...
  async init(uri, dtoIn, session) {
    ...
    if (dtoIn.uuBtLocationUri) {
      ...
      const createAwscDtoIn = {
        name: "UunBcaa21sft04",
        typeCode: "uun-bcaa21sft04-maing01",
        location: location,
...
module.exports = new Bcaa21sft04MainAbl();
